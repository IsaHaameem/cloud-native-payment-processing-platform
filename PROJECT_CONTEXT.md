...
>
> **Frozen as of M14 (2026-07-20).** This document is Version 1's historical record
> (M0–M14) and is not updated for work past that point — including this file's own
> §6/§7 references to an upcoming "M15" (a Next.js merchant console), which reflects
> V1's original, since-superseded plan. All work from M15 onward — including a
> redefined M15 (API-key authentication) — is tracked in `PROJECT_CONTEXT_2.md`,
> Version 2's own single source of truth. Do not edit this file except where genuine
> backwards compatibility with V1 requires it.
