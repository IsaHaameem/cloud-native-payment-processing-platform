...
# ../Dockerfile with those two ARGs defaulted for agentic-commerce-service, and nothing else changed.
#
...
ARG SERVICE_MODULE=agentic-commerce-service
WORKDIR /workspace
