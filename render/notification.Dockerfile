...
# ../Dockerfile with those two ARGs defaulted for notification-service, and nothing else changed.
#
...
ARG SERVICE_MODULE=notification-service
WORKDIR /workspace
