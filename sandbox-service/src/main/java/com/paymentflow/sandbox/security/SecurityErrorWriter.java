package com.paymentflow.sandbox.security;
 ...
 * filter chain (before the DispatcherServlet) — mirrors payment-service's class of the
 * same name so both services produce the identical contract.
 */
@Component
