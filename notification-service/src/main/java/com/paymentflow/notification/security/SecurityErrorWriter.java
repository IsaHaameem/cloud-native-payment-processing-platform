package com.paymentflow.notification.security;
 ...
 * cannot see them) — mirrors sandbox-service's and payment-service's classes of the same
 * name so every service produces the identical contract.
 */
@Component
