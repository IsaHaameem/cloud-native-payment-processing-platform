 ...
 * consumer) — decoupled from either specific side effect (email log, webhook delivery
 * intent) below it. Mirrors transaction-service's identical {@code ProcessedEvent} (M6).
 */
@Entity
